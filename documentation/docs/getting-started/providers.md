...
| [Z.AI](https://z.ai/)                                                       | Access to Z.AI's GLM models: the GLM-5 family (glm-5.3, glm-5.2, glm-5.1, glm-5, glm-5-turbo), the GLM-4.x line (glm-4.7, glm-4.6, glm-4.5 and their Air/X/Flash/FlashX variants), and the GLM vision models (glm-5v-turbo, glm-4.6v, glm-4.5v). Context windows up to 1M tokens. **Requires an [API key](https://docs.z.ai/guides/overview/quick-start)**.  Set `ZAI_HOST` to `https://api.z.ai/api/coding/paas/v4` to bill against a flat-rate [GLM Coding Plan](https://docs.z.ai/devpack/quick-start) instead of per-token API credit. | `ZAI_API_KEY`, `ZAI_HOST` (optional)                                                                                                                                                |

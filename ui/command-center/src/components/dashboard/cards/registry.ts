...
export const CARD_REGISTRY: Record<string, CardRegistryEntry> = {
  ...
  decisions: { component: DecisionsCard, name: 'Decisions',      description: 'What Henry needs from you',     defaultSize: { w: 5, h: 4 } },
  stats:     { component: StatsCard,    name: 'Stats',           description: 'Sessions today, memory nodes',  defaultSize: { w: 5, h: 4 } },
  in_flight: { component: InFlightCard, name: 'In Flight',       description: 'Currently running sessions',    defaultSize: { w: 12, h: 3 } },

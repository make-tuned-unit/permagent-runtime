  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontFamily: font.mono, fontSize: 10, color: color.textDim,
      }}>
      ...
      >
        ...
        {state.loading && (
          <div style={{ padding: 20, textAlign: 'center', fontFamily: font.mono, fontSize: 11, color: color.textDim }}>
            Loading...
          </div>
        )}

        {!state.loading && filtered.length === 0 && (
          <div style={{ padding: 40, textAlign: 'center', fontFamily: font.body, fontSize: 13, color: color.textMuted }}>
            {isSearch ? 'No memories match your search.' : 'No memories yet.'}
          </div>
        )}

        {state.hasMore && !state.loading && (
          <div style={{ padding: 12, textAlign: 'center', fontFamily: font.mono, fontSize: 10, color: color.textDim }}>
            Scroll for more...
          </div>
        )}
      </div>
...
function MemoryRow({ memory, selected, highlightTerms, onClick }: {
  ...
  return (
    ...
    >
      ...
      {descPreview && (
        <div style={{
          fontFamily: font.body, fontSize: 12, color: color.textMuted, lineHeight: 1.5,
      ...
      <div style={{
        ...
        fontFamily: font.mono, fontSize: 9, color: color.textDim,
      }}>

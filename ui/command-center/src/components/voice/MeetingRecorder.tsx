        ...
        >
          <div style={{
            ...
            <div style={{ fontSize: 11, color: colors.textMuted, lineHeight: 1.5, marginBottom: 10 }}>
              Records your own voice from this machine's microphone (not the other
              side of a call), transcribes it locally on this device — nothing is
              sent to a cloud service — and saves the transcript as a note on the
              project you pick when you stop.
            </div>

  ...
  return (
    <div style={{ marginTop: 12 }}>
      ...
      {previewGroup && !cleaning && (() => {
        ...
        return (
          <div style={{ marginBottom: 16, borderRadius: radius.lg, overflow: 'hidden', border: `1px solid ${colors.borderHi}`, background: 'rgba(10,14,23,0.8)' }}>

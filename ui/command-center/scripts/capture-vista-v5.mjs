#!/usr/bin/env node
/*
 * Job 20 evidence, v5: the belvedere check.
 *
...
const reportPath = path.join(repo, 'docs/design/solar-forum/vista-frame-v5.json');
...
const day = await measure('day', 'v5-vista-day');
const night = await measure('night', 'v5-vista-night');

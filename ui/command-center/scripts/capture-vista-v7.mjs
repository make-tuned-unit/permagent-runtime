...
const reportPath = path.join(repo, 'docs/design/solar-forum/vista-frame-v7.json');
...
const day = await measure('day', 'v7-vista-day');
const night = await measure('night', 'v7-vista-night');

...
use permagent::agents::extension_manager::{ExtensionManager, ExtensionManagerCapabilities};
use permagent::agents::GoosePlatform;
...
async fn test_replayed_session(
    ...
    let session_manager = Arc::new(permagent::session::SessionManager::new(

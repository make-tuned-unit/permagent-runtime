...
use permagent::agents::{Agent, AgentEvent, GoosePlatform};
use permagent::config::extensions::{set_extension, ExtensionEntry};
...
mod tests {
    ...
    mod schedule_tool_tests {
        ...
        use permagent::session::{Session, SessionManager};
        ...
        async fn test_schedule_management_tool_list() {
            ...
            assert!(tool
                ...
                .clone()
                .unwrap_or_default()
                .contains("scheduled recipe execution"));
        }
    ...
    mod retry_tests {
        use super::*;
        use permagent::agents::types::{RetryConfig, SuccessCheck};

        #[tokio::test]
        async fn test_retry_success_check_execution() -> Result<()> {
            use permagent::agents::retry::execute_success_checks;
    ...
    mod max_turns_tests {
        ...
        impl ProviderDef for MockToolProvider {
            ...
            fn from_env(
                _model: ModelConfig,
                _extensions: Vec<permagent::config::ExtensionConfig>,
    ...
    mod tool_pair_summarization_tests {
        ...
        use async_trait::async_trait;
        use permagent::agents::SessionConfig;
        use permagent::config::base::Config;
        use permagent::config::GooseMode;

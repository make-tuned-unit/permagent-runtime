...
//!
//! NOTE: mirrored (same heuristics, same thresholds) in
//! `crates/goose-mcp/src/computercontroller/text_quality.rs` — the mcp crate
//! cannot depend on this crate. Keep the two in sync.

    ...
    crate::agents::self_knowledge::FeatureDescriptor {
        ...
        what_it_does:
            "You can directly perceive the aggregate data your Permagent home renders by \
             ...
             briefings, grow, brain, build, world, settings, or an overview. This is structured \
             local state, not screenshot vision and not the website in the Build browser. \
...
struct ObserveAppParams {
    ...
    /// sessions, briefings, grow, brain, build, world, settings, or overview.
    surface: String,
        ...
        let info = InitializeResult::new(ServerCapabilities::builder().enable_tools().build())
            ...
            .with_instructions(
                "Read the structured data behind the Permagent app. Use observe_app directly \
                 ...
                 spend, sessions, growth actions you have recommended, agent briefings, brain \
                 memory health, build coding sessions or browser bookmarks, world workers, \
                 settings configuration, or the overall home. Do not navigate first \
    ...
    pub(crate) fn get_tools() -> Vec<Tool> {
        vec![Tool::new(
            ...
            "Read aggregate state from the data behind the Permagent app. Call this directly \
             ...
             actions you recommended, agent briefings, brain memory health, build coding \
             sessions or browser bookmarks, world workers, settings configuration, or what \
             ...
             grow | brain | build | world | settings | overview. analytics and cards require \

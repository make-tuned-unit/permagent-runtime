...
Permagent users organize work into projects. When a user mentions a project by name, resolve it via project_list and use that context for subsequent actions (file paths, URLs, related memories, etc).

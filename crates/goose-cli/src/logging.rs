...
fn setup_logging_internal(name: Option<&str>, force: bool) -> Result<()> {
    ...
    let mut setup = || {
        result = (|| {
            let log_dir = permagent::logging::prepare_log_directory("cli", true)?;
...
mod tests {
    ...
    fn test_log_directory_creation() {
        ...
        let log_dir = permagent::logging::prepare_log_directory("cli", true).unwrap();

...
fn main() {
    ...
    if has_stt {
        ...
        let _stt = sherpa_onnx::OfflineRecognizer::create(
                ...
                model_config: sherpa_onnx::OfflineModelConfig {
                    moonshine: sherpa_onnx::OfflineMoonshineModelConfig {
                        ...
                        uncached_decoder: Some(
                            stt_dir.join("uncached_decode.int8.onnx").to_string_lossy().into(),
                        ),
                        cached_decoder: Some(
                            stt_dir.join("cached_decode.int8.onnx").to_string_lossy().into(),
                        ),
                        ..Default::default()
                    },
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        let g2p_bg = Arc::new(Mutex::new(misaki_rs::G2P::new(misaki_rs::Language::EnglishGB)));

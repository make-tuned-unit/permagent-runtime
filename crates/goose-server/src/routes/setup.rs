...
use permagent::config::signup_nanogpt::{complete_nanogpt_auth, configure_nanogpt};
use permagent::config::signup_openrouter::OpenRouterAuth;
use permagent::config::signup_tetrate::{configure_tetrate, TetrateAuth};
use permagent::config::{configure_openrouter, Config};
use serde::Serialize;
use std::sync::Arc;
use utoipa::ToSchema;

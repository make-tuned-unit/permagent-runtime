...
use permagent::scheduler::{get_default_scheduled_recipes_dir, ScheduledJob};
...
async fn create_schedule(
    ...
    scheduler
        ...
        .map_err(|e| match e {
            ...
            permagent::scheduler::SchedulerError::JobIdExists(msg) => ErrorResponse {
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| match e {
        ...
        permagent::scheduler::SchedulerError::AnyhowError(err) => {

...
use permagent::permission::permission_confirmation::{Permission, PrincipalType};
use permagent::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use permagent::session::{Session, SessionInsights, SessionType, SystemInfo};
use rmcp::model::{
...
use permagent::config::declarative_providers::{
...
#[openapi(
    paths(
        ...
        super::routes::config_management::set_extension_enabled_route,
        ...
        super::routes::config_management::list_workspace_trust,
        super::routes::config_management::trust_workspace,
        super::routes::config_management::untrust_workspace,
    ...
    components(schemas(
        ...
        super::routes::config_management::SetExtensionEnabledRequest,
        super::routes::config_management::ToolPermission,
        super::routes::config_management::UpsertPermissionsQuery,
        super::routes::config_management::WorkspaceTrustQuery,
        super::routes::config_management::WorkspaceTrustListResponse,
        super::routes::config_management::WorkspaceTrustMutationResponse,
        super::routes::config_management::UpdateCustomProviderRequest,
        permagent::providers::catalog::ProviderCatalogEntry,
        permagent::providers::catalog::ProviderTemplate,
        permagent::providers::catalog::ModelTemplate,
        permagent::providers::catalog::ModelCapabilities,
        ...
        permagent::prompt_template::Template,
        ...
        ModelConfig,
        Session,
        permagent::config::goose_mode::GooseMode,
        SessionInsights,
        SessionType,
        SystemInfo,
        Conversation,
        IconSchema,
        IconThemeSchema,
        permagent::session::extension_data::ExtensionData,
        ...
        super::routes::recipe_utils::UntrustedRecipeDir,
        ...
        permagent::recipe::Recipe,
        permagent::recipe::Author,
        permagent::recipe::Settings,
        permagent::recipe::RecipeParameter,
        permagent::recipe::RecipeParameterInputType,
        permagent::recipe::RecipeParameterRequirement,
        permagent::recipe::Response,
        permagent::recipe::SubRecipe,
        permagent::agents::types::RetryConfig,
        permagent::agents::types::SuccessCheck,
        ...
        permagent::agents::ExtensionLoadResult,
        ...
        permagent::goose_apps::CspMetadata,
        permagent::goose_apps::PermissionsMetadata,
        permagent::goose_apps::UiMetadata,
        permagent::goose_apps::ResourceMetadata,
...
#[openapi(
    ...
    components(schemas(
        ...
        permagent::providers::local_inference::hf_models::HfModelInfo,
        permagent::providers::local_inference::hf_models::HfGgufFile,
        permagent::providers::local_inference::hf_models::HfQuantVariant,
        super::routes::local_inference::RepoVariantsResponse,
        permagent::providers::local_inference::local_model_registry::ModelSettings,
        permagent::providers::local_inference::local_model_registry::SamplingConfig,
    ))
)]
